defmodule ExSolomonWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ExSolomonWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ExSolomonWeb.Gettext, "errors", msg, opts)
    end
  end
